...
@router.post(
    ...
    description="Создание нового строительного проекта. Код проекта (4 цифры) можно указать вручную или оставить для автогенерации."
)
async def create_project(
    ...
    # Использовать tenant пользователя если не указан
...
async def list_projects(
    ...
    # Фильтровать по tenant пользователя, если не суперпользователь
...
async def get_project(
    ...
    # Проверка доступа (тот же tenant или суперпользователь)
...
async def update_project(
    ...
    logger.info(f"[update_project] Received update for project {project_id}: {data.model_dump(exclude_unset=True)}")
...
# =============================================================================
# Эндпоинты назначения менеджеров
# =============================================================================
...
# =============================================================================
# Публичные эндпоинты (для анонимной загрузки)
# =============================================================================
