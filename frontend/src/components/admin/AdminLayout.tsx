...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-30 w-64 bg-gray-800 transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-6 bg-gray-900">
          <Link to="/admin" className="flex items-center space-x-2">
            ...
            <span className="text-lg font-bold text-white">SeverinAutoprotocol</span>
          </Link>
          <button
            onClick={() => setSidebarOpen(false)}
